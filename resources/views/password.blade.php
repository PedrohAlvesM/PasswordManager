...
<head>
    ...
    @vite(['resources/css/app.css', 'resources/css/password.css', 'resources/css/notification.css', 'resources/css/button.css', 'resources/css/input.css', 'resources/css/root.css', 'resources/js/password.js', 'resources/js/notification.js'])
...
<body class="flex-container">
    ...
    <main class="main-container flex-container shadow">
        <div class="flex-container search-box">
            ...
            <div class="actions">
                <img id="btn-done" class="image shadow" src="{{URL('assets/done.svg')}}" alt="done">
                <img id="btn-change" class="image shadow" src="{{URL('assets/change.svg')}}" alt="change">
                <img id="btn-delete" class="image shadow" src="{{URL('assets/delete.svg')}}" alt="delete">
            </div>
        </div>
        <div class="table-container">
            ...
            <img class="image shadow btn-copy" src="{{URL('assets/copy.svg')}}" alt="copy">
            ...
            <img class="image shadow btn-copy" src="{{URL('assets/copy.svg')}}" alt="copy">
            <button class='button shadow' id="backup">Backup</button>
        </div>   
    </main>
